...
public class MainController {
    ...
    // public ResponseEntity<Map<String, Object>> login(@RequestBody LoginForm
    // loginForm) {
    ...
    // List<Users> userOptional =
    // this.usersRepository.findByNrik(loginForm.getUsername().toString());
    ...
    // UsernamePasswordAuthenticationToken.authenticated(loginForm.getUsername(),
